...
const en: SiteContent = {
	...
	home: {
		...
		about: {
			...
			imageAlt:
				"Macro detail of an industrial control board manufactured by C&S",
	...
	solutions: {
		...
		hero: {
			...
			lede: "Positioning systems, protection systems, and lifecycle engineering services — designed and manufactured by C&S Controles y Sistemas.",
		},
		sections: {
			positioning: {
				type: "product",
			...
			services: {
				...
				items: [
					...
					},
					{
						...
						subsections: [
							{
								heading: "Pickling lines",
								bullet: "Catenary measurement system",
							},
							{
								heading: "Coke plant",
	...
	contact: {
		...
		info: {
			...
			address: {
				label: "Address",
				lines: ["3301 N UNIVERSITY DR, SUITE 100, CORAL SPRINGS, FL 33065"],
			},
			phone: {
				label: "Phone",
	...
	footer: {
		...
		copyright: (year) =>
			`© ${year} C&S Controles y Sistemas. All rights reserved.`,
	},
};
