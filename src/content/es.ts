...
const es: SiteContent = {
  ...
  home: {
      ...
      items: [
        {
          ...
          items: ['I+D electromecánico', 'Diseño de PCB y carcasa', 'Ingeniería inversa'],
        },
        {
          code: 'C-02',
          title: 'Fabricación',
          ...
          items: ['Producción de repuestos', 'Entrega llave en mano', 'Carcasas personalizadas'],
        },
        {
          code: 'C-03',
          title: 'Mantenimiento',
          ...
          items: ['Variadores y PLCs', 'Conversores de potencia', 'Calibración de sensores'],
        },
        {
          code: 'C-04',
          title: 'Siderurgia',
    ...
    about: {
      ...
      imageAlt: 'Detalle macro de una placa de control industrial fabricada por C&S',
      badge: 'Archivo · CYS-PCB-014',
    },

    trustedBy: {
      accent: 'Socios de confianza',
  ...
  solutions: {
    ...
    hero: {
      ...
      lede:
        'Sistemas de posicionamiento, sistemas de protección y servicios de ingeniería a lo largo del ciclo de vida — diseñados y fabricados por C&S Controles y Sistemas.',
    },
    sections: {
      positioning: {
        type: 'product',
        ...
        items: [
          {
            ...
            ctas: [
              { label: 'Solicitar información', href: '/contact', variant: 'primary' },
              {
                label: 'Descargar PDF',
      ...
      protection: {
        ...
        items: [
          ...
          },
          {
            ...
            ctas: [{ label: 'Solicitar información', href: '/contact', variant: 'primary' }],
          },
        ],
      },
          ...
          },
          {
            ...
            subsections: [
              { heading: 'Líneas de decapado', bullet: 'Sistema de medición de catenaria' },
              {
                ...
                bullet: 'Sistema de posicionamiento infrarrojo para hornos de coque',
              },
            ],
          },
        ],
  ...
  contact: {
    ...
    info: {
      ...
      address: {
        label: 'Dirección',
        lines: ['Garibaldi 611', 'B2900 San Nicolás de Los Arroyos', 'Provincia de Buenos Aires'],
      },
      phone: {
        label: 'Teléfono',
  ...
  footer: {
    tagline: 'Diseño, desarrollo y mantenimiento de electrónica industrial desde 1991.',
    navColumn: 'Navegación',
    contactColumn: 'Contacto',
    copyright: (year) => `© ${year} C&S Controles y Sistemas. Todos los derechos reservados.`,
    version: 'v2.0',
  },
};
